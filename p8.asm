# p8.asm
#
#  more complex control, R-type, I-type, some pseudos
...
L0:    
       ...
       slt   $at, $s6, $s0          # see if current element < ceiling
       beq   $at, $zero, skip
...
skip:
       ...
       slt   $at, $t1, $s7          # see if at end of array
       bne   $at, $zero, L0         # restart loop if necessaary
